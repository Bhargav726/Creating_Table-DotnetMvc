        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PersonReceiveNewsLetters = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Persons_Countries_PersonCountryId",
            ...
            migrationBuilder.InsertData(
                table: "Persons",
                columns: new[] { "PersonId", "PersonAddress", "CountryId", "PersonDOB", "PersonEmail", "PersonGender", "PersonName", "PersonReceiveNewsLetters", "TIN" },
                values: new object[,]
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Persons_PersonCountryId",
                table: "Persons",
                column: "CountryId");
        }
